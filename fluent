...
local Themes = {
	...
	iOSLiquidGlass = {
		...
		AcrylicMain = Color3.fromRGB(240, 242, 245),
		...
		ToggleSlider = Color3.fromRGB(0, 122, 255),
		...
		DropdownOption = Color3.fromRGB(0, 122, 255),
		Keybind = Color3.fromRGB(100, 100, 100),
		Input = Color3.fromRGB(255, 255, 255),
		InputFocused = Color3.fromRGB(245, 245, 245),
		InputIndicator = Color3.fromRGB(0, 122, 255),
		InputIndicatorFocus = Color3.fromRGB(0, 122, 255),
		...
		DialogInputLine = Color3.fromRGB(0, 122, 255),
